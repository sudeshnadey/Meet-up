...
<Typography className={classes.heading}  variant="h4" gutterBottom  style={{ fontWeight: '400', }}>
Welcome to the m. eet app 🍑
</Typography>
<Typography className={classes.text}  variant="h6" gutterBottom style={{ marginTop: '80px', }}>
Login with email 
</Typography>
...
Don’t have an account?  <span style={{ color: '#FB451A'}}>Signup</span>
</Typography>
